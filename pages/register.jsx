        ...
        <main className={styles.main}>
          <div className="container">
            <div className={styles.wrapper}>
              <div className={styles.left}>
                <div>
                  ...
                  <div className={styles.add}>
                    ...
                    <Link className={styles.remember} href="/remember">
                      Forgot password?
                    </Link>
                  </div>
                  <button
              ...
              <img className={styles.image} src="/images/auth.webp" alt="" />
            </div>
          </div>
        </main>
      )}
